  ...
  <div className="basketball--container">
    ...
    <div className="teams">
        ...
        <div className="score--home">{home.score}</div>
          ...
          <button id="score-one-home"
                  onClick={scoreOne}>Score 1pt
          </button>
          <button id="score-two-home"
                  onClick={scoreTwo}>Score 2pts
          </button>
          <button id="score-three-home"
                  onClick={scoreThree}>Score 3pts
          </button>
        </div>
        <div className="team--away">
        <div className="score--away">{away.score}</div>
          <h3 className="team--away--name">{away.name}</h3>
          <button id="score-one-away"
                  onClick={scoreOne}>Score 1
          </button>
          <button id="score-two-away"
                  onClick={scoreTwo}>Score 2pts
          </button>
          <button id="score-three-away"
                  onClick={scoreThree}>Score 3pts
          </button>
        </div>
    </div>
